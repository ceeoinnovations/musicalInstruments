# By Rose Kitz
# With Julia Zelevinsky and Anna Quiros
# FET Lab Summer 2022
...
#defining variables
min_dist = 30 # what's the closest == CHANGE THESE
max_dist = 230 # what's the farthest == CHANGE THESE
positions_min_distances = [min_dist, 50, 70, 100, 135, 170, 198, max_dist] # --> Start/ranges of each position
...
def choose_note():
    ...
    notes_by_position_letters = [['a2', 'F3', 'a3', 'D4', 'F4'], ['A2', 'E3', 'A3', 'c4', 'E4'], ['g2', 'd3', 'g3', 'C4'], ['G2', 'D3', 'G3', 'B3'], ['f2', 'c3', 'f3'], ['F2', 'C3'],['E2', 'B2']]
